...
// Écran vu uniquement par les non-admins (les admins voient l'écran Calendrier admin, avec
// accès à tous les pop-ups et au local) : ne montre donc jamais que son propre planning.
                ...
                <View style={{ flexDirection: 'row', gap: 8 }}>
                  {jours.map((jour) => {
                    ...
                    const heureFermeture = ouvert
                      ...
                      : '20:00:00';
                    const shiftsJour = (shifts ?? []).filter(
                      (s) => s.date === dateIso && s.statut === 'publie' && s.profile_id === profile?.id,
                    );
